...
export const PRIMITIVES = [
  ...
  {
    id: 'carnac.durable_read',
    family: 'Carnac™',
    label: 'Durable tenant-scoped read',
    status: 'protected',
    method: 'POST',
    endpoint: '/v1/carnac/judge',
    auth: 'bearer+tenant',
    description: 'The durable, tenant-scoped read that persists to the ledger and carries a post-quantum signature. Requires a bearer credential and a configured durable ledger and typed signer.',
    sample_curl: null,
  },
  {
    id: 'carnac.export',
